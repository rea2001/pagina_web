...
def show_home_page():
    ...
    despliegues_data = [
        {"ID": 101, "Motor": "Bomba A", "Fecha": "2024-01-15", "Puntos": "50,243", "Estado": "✅ Procesado"},
        {"ID": 102, "Motor": "Bomba B", "Fecha": "2024-01-14", "Puntos": "48,512", "Estado": "✅ Procesado"},
        {"ID": 103, "Motor": "Motor 1", "Fecha": "2024-01-13", "Puntos": "52,100", "Estado": "⏳ Procesando"},
        {"ID": 104, "Motor": "Motor 2", "Fecha": "2024-01-12", "Puntos": "47,850", "Estado": "❌ Sin procesar"},
    ]
    ...
    for d in despliegues_data:
        ...
        with cols[4]:
            ...
            st.markdown(f"<span style='color:{status_color[d['Estado']]}'>{d['Estado']}</span>", 
                       unsafe_allow_html=True)
        with cols[5]:
